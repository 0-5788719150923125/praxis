...
class TestMainScript:
    ...
    def test_main_smoke_test_dev_mode(self):
        ...
        assert "parameters:" in result.stdout.lower() or "loaded:" in result.stdout.lower()
    ...
    def test_main_help_argument(self):
        ...
        assert "praxis cli" in result.stdout.lower() or "usage:" in result.stdout.lower()
    ...
    def test_main_interrupt_handling(self):
        ...
        cmd = [
            ...
            "main.py",
            "--dev",
            "--max-steps", "100",  # More steps so we have time to interrupt
            "--batch-size", "1",
            "--device", "cpu",
            "--no-dashboard",
            "--quiet",
    ...
    def test_main_with_different_block_types(self):
        ...
        for block_type in block_types:
            ...
            assert result.returncode == 0, f"Training with --block-type {block_type} failed:\n{result.stderr}"
