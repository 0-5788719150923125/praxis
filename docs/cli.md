...
| `--ffn-type` | str | `glu` | The feedforward-network implementation to use within each block (choices: mlp, glu, dual_act, arc, poly, scatter, kan, peer, peer_glu, peer_dual, peer_split, peer_split_even, eml_tree, spline) |
