...
| `--optimizer-wrappers` |  | `[]` | Optimizer wrappers to stack, in order. Choices: gated_schedule_free, lookahead, ortho, schedule_free, trac, wave_schedule_free. E.g. --optimizer-wrappers ortho gated_schedule_free (choices: gated_schedule_free, lookahead, ortho, schedule_free, trac, wave_schedule_free) |
