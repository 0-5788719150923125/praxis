...
| Flag | Type | Default | Description |
| --- | --- | --- | --- |
| `--activation` | str | `mish` | The primary activation function to use (choices: gelu, gelu_10, gelu_accurate, gelu_fast, gelu_new, gelu_python, gelu_python_tanh, gelu_pytorch_tanh, hardswish, jagged_sin, laplace, leaky_relu, linear, mish, mix, mix_affine, mix_gated, mix_split, nmda, ouroboros, periodic_relu, prelu, quick_gelu, relu, relu2, relu6, serf, serpent, servant, sigmoid, silu, sin, sin_cos, sinlu, snake, sqrtsoftplus, swish, tanh, xielu) |
...
| `--ffn-type` | str | `glu` | The feedforward-network implementation to use within each block (choices: mlp, glu, dual_act, arc, poly, scatter, kan, peer, peer_glu, peer_dual, peer_split, peer_mix, eml_tree, spline) |
...
| `--train-datasets` | str | `['base']` | Named dataset collections to train on. Space- or comma-separated (e.g. '--train-datasets base phi' or '--train-datasets base,phi'). Available: base, chat, cot, dev, focused, git_history, joke, phi, pile, preference, print, rl, slimpajama, tools, validation. |
