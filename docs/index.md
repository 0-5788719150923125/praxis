...
Praxis is built around 43 pluggable registries. The feature categories below link to a page listing the registered implementations and their source.
...
- [Input encoders](encoders.md) (13) - Front-end encoders, including the byte-latent and abstractinator variants.
