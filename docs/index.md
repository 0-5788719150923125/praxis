...
Praxis is built around 53 pluggable registries. The feature categories below link to a page listing the registered implementations and their source.

## Feature registries

- [Activation functions](activations.md) (39) - Pointwise nonlinearities used inside blocks and heads.
...
- [Feedforward experts](dense.md) (14) - How a block's feedforward path is realized: MLP, GLU, KAN, polynomial, scatter, PEER, ... Selected with ``--ffn-type``; default is ``glu``.
