...
- [Attention mechanisms](attention.md) (17) - Self-attention variants, from vanilla causal MHA to compressive-memory and per-depth-biased variants.
...
- [Feedforward experts](dense.md) (12) - How a block's feedforward path is realized: MLP, GLU, KAN, polynomial, scatter, PEER, ... Selected with ``--ffn-type``; default is ``glu``.
