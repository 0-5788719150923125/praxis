...
Praxis is built around 46 pluggable registries. The feature categories below link to a page listing the registered implementations and their source.
...
- [Input encoders](encoders.md) (15) - Front-end encoders, including the byte-latent and abstractinator variants.
