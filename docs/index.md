...
Praxis is built around 45 pluggable registries. The feature categories below link to a page listing the registered implementations and their source.
...
- [Input encoders](encoders.md) (14) - Front-end encoders, including the byte-latent and abstractinator variants.
