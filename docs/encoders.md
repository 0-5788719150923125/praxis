...
Source: [praxis/encoders/calm/encoder.py:46](../praxis/encoders/calm/encoder.py#L46)
...
- `calm_byte_small` - `ae_dropout=0.1, ae_hidden=1.0, chunk_size=4, energy_alpha=1.0, energy_blocks=3, energy_samples_m=64, energy_samples_n=8, kl_beta=0.001, kl_clip=0.5, latent_dim=0.25, noise_dim=0.25, vote_num_samples=50`
