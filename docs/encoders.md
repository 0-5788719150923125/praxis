...
Source: [praxis/encoders/calm/encoder.py:43](../praxis/encoders/calm/encoder.py#L43)
...
- `calm_byte_small` - `ae_dropout=0.1, ae_hidden=1.0, chunk_size=8, energy_alpha=1.0, energy_blocks=2, energy_samples_m=16, energy_samples_n=4, kl_beta=0.001, kl_clip=0.5, latent_dim=0.25, noise_dim=0.25`
