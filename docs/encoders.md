...
Registry: ``praxis.ENCODER_REGISTRY`` (25 entries)

## `abstractinator`, `abstractinator_harmonic`, `abstractinator_harmonic_gdn_vocab_bank`, `abstractinator_harmonic_serpent`, `abstractinator_harmonic_serpent_avg`, `abstractinator_harmonic_serpent_vocab_bank`, `abstractinator_harmonic_vocab_bank` - AbstractinatorEncoder
