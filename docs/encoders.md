...
- `calm_byte_ref` - `ae_dropout=0.15, ae_hidden=512, chunk_size=8, energy_alpha=1.0, energy_anchor_weight=5.0, energy_blocks=4, energy_prior='none', energy_samples_m=100, energy_samples_n=8, kl_beta=0.001, kl_clip=0.5, latent_dim=128, latent_norm=True, noise_dim=64, vae_depth=4, vote_num_samples=500`
...
- `calm_tm_ref` - `ae_dropout=0.15, ae_hidden=512, chunk_size=4, energy_alpha=1.0, energy_anchor_weight=5.0, energy_blocks=4, energy_prior='none', energy_samples_m=100, energy_samples_n=8, kl_beta=0.001, kl_clip=0.5, latent_dim=128, latent_norm=True, noise_dim=64, vae_depth=4, vote_num_samples=500`
