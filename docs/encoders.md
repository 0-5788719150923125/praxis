...
## `abstractinator`, `abstractinator_harmonic`, `abstractinator_harmonic_serpent`, `abstractinator_harmonic_serpent_avg`, `abstractinator_harmonic_serpent_vocab_bank` - AbstractinatorEncoder
