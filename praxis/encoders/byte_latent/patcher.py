...
class Patcher:
    ...
    def _space_patching(
        ...
        """
        Create patches at space boundaries.
        ...
        # Space is typically byte 32 + offset
        space_token = 32 + OFFSET

        # Create boundaries at space tokens
        boundaries = tokens == space_token
