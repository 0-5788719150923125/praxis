    ...
    return `
        <header class="header">
            ...
            <div class="header-actions">
                ...
                ${donationButton}
                <button class="theme-toggle-button" id="screenshot-btn" title="Screenshot" aria-label="Screenshot">
                    <!-- The camera glyph fills its 16-unit viewBox edge to edge
                         (bell/gear don't), so render it slightly smaller. -->
