...
prismatic4 terminal classifier's crystal bank. The experts stay distinct via a VEAR-
...
harmonic activation matches the codec/memory/classifier; the heavy HarmonicField grid
...
class _HarmonicExpert(nn.Module):
    ...
    byte-level MTP so it matches the shared byte classifier's input width)."""
    ...
    def __init__(self, config) -> None:
        ...
        # activation the codec, memory, and classifier use.
