...
class TerminalDashboard:
    ...
    def _create_frame(self):
        ...
        for i in range(height):
            ...
            right_content = self.text_utils.truncate_to_width(right_content, right_width)
        ...
        frame.append(self.frame_builder.create_footer_separator(half_width, right_width))
