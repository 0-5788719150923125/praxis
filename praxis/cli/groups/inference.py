    ...
    def add_arguments(cls, parser):
        ...
        group.add_argument(
            ...
            doc=(
                ...
                "it. To shorten replies without a hard cap, reach for "
                "``exponential_decay_length_penalty=[start, factor]`` (it boosts "
                "the EOS score after ``start`` generated tokens) - NOT "
                "``length_penalty``, which only ranks finished beams and does "
                "nothing at all under sampling. These become the defaults the "
                "web app's Settings form is "
