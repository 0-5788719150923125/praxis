...
class TokenMonsterTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, config, **kwargs):
        ...
        # Create the added_tokens_decoder dictionary with the complete vocabulary
        # added_tokens_decoder = {
        #     token_id: AddedToken(
        #         content=self.tokenizer.id_to_token(token_id), normalized=True
        #     )
        #     for token_id in range(self.tokenizer.vocab_size)
        # }

        # # Add the special tokens to the added_tokens_decoder
        # added_tokens_decoder.update(
        #     {
        #         self.tokenizer.token_to_id(self.pad_token): self.pad_token,
        #         self.tokenizer.token_to_id(self.bos_token): self.bos_token,
        #         self.tokenizer.token_to_id(self.eos_token): self.eos_token,
        #         self.tokenizer.token_to_id(self.unk_token): self.unk_token,
        #     }
        # )
    ...
    def decode(
        ...
        **kwargs,
        ...
        return self.convert_tokens_to_string(token_ids)
    ...
    #     #     "Adding new tokens is not supported by TokenMonsterTokenizer"
    #     # )
    #     pass
