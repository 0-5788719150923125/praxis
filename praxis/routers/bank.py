"""Bank merging: N copies of ONE module, merged by a routing distribution.

This is SMEAR's mechanism (https://arxiv.org/abs/2306.03745) in its original
...
class ExpertBankConfig:
    """Configuration class for an expert bank."""
...
class ExpertBank(nn.Module):
    ...
    # Opt out of the targeted merge (praxis/routers/targeting.py). A bank
...
# --- sharpened variant (the repo's own VEAR) ---------------------------------
...
class SharpenedExpertBank(ExpertBank):
