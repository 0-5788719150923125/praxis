...
Where a :mod:`~praxis.pillars.framing` fragment injects a whole section, an
...
# Inline-edit definitions live in this package's own directory, beside this file.
INLINES_DIR = Path(__file__).parent
# This file is now praxis/pillars/inlines/__init__.py, so repo root is parents[3].
...
def export_inlines() -> Dict:
    ...
    lines = ["% Generated by praxis/pillars/inlines - do not edit by hand."]
    resolved, absent = {}, []
