"""Recent-run validation curves, rendered to LaTeX data for the paper.
...
Entry point: :func:`export_once`, driven by :mod:`praxis.research.build`.
...
def export_once(n: int, metric_arg: str):
    ...
    var_lines.append("% Generated by praxis/research/runs.py - do not edit by hand.")
