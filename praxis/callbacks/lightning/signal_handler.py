            ...
            if self.signal_count == 1:
                ...
                def parallel_shutdown():
                    ...
                    if torch.cuda.is_available() and torch.cuda.is_initialized():
                        ...
                        threads.append(threading.Thread(target=cuda_cleanup, daemon=True))
                ...
                shutdown_thread = threading.Thread(target=parallel_shutdown, daemon=True)
                ...
                if self.trainer_ref is not None:
                    ...
                    if hasattr(self.trainer_ref, 'state') and hasattr(self.trainer_ref.state, 'stage'):
                        stage = str(self.trainer_ref.state.stage) if self.trainer_ref.state.stage else ""
